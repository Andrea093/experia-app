...
import {
  useStore, XS, nav, doLogout, selectArea, changeArea, enrollInCourse,
...
const App = () => {
  ...
  if (role === 'student' && hasCourses && !enrolledCourse) return <CourseSelection />;
  // Guard legado: sin cursos en BD y sin área → selección de área
  if (role === 'student' && !hasCourses && !selectedArea) return <AreaSelection />;
