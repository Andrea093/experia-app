  ...
  render() {
    ...
    return (
      <div style={{ height:'100vh', display:'flex', alignItems:'center', justifyContent:'center',
        flexDirection:'column', gap:16, padding:24, background:'#F9FAFB', fontFamily:"'DM Sans', sans-serif" }}>
        <div style={{ fontSize:48 }}>⚠️</div>
        <h2 style={{ fontSize:20, fontWeight:700, color:'#1A1A2E', margin:0 }}>Algo salió mal</h2>
        ...
        {import.meta.env.DEV && (
          <pre style={{ fontSize:11, color:'#EF4444', background:'#FEF2F2', padding:16,
