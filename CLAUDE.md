...
| `quiz` | Multiple-choice questions | `{ questions: [{question,options,correct, image?,imageHeight?,imagePosition?,optionImages?,explanation?,explanationImage?,timeLimit?,points?,difficulty?}], passage? }` |
